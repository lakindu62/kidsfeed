...
class UpdateRecipeRequest {
  ...
  constructor(body) {
    ...
    if (body.ingredients !== undefined) {this.ingredients = body.ingredients;}
    if (body.instructions !== undefined) {this.instructions = body.instructions;}
    if (body.dietaryFlags !== undefined) {this.dietaryFlags = body.dietaryFlags;}
    if (body.allergens !== undefined) {this.allergens = body.allergens;}
    if (body.servingSize !== undefined) {this.servingSize = body.servingSize;}
    if (body.prepTime !== undefined) {this.prepTime = body.prepTime;}
    if (body.seasonal !== undefined) {this.seasonal = body.seasonal;}
  }
